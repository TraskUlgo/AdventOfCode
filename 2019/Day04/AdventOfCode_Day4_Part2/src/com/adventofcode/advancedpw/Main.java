package com.adventofcode.advancedpw;
	...
	public static boolean checkAdjacentDigits(int number) {
		...
		for(int i = 0; i < digits.size()-1; i++) {	
			if(i == 0 && digits.get(i) == digits.get(i+1)) {
				if(digits.get(i+2) != digits.get(i)) {
					return true;
				}
			}
			else if(i == digits.size()-2 && digits.get(i) == digits.get(i+1)) {
				if(digits.get(i-1) != digits.get(i)) {
					return true;
				}
			}
			else if(digits.get(i) == digits.get(i+1)) {
				if(digits.get(i+2) != digits.get(i) && digits.get(i-1) != digits.get(i)) {
					return true;
				}
			}
		}
